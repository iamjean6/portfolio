...
/**
 * WebDesignCard — index 3 in the interests slider.
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="card-description">
            Crafting bold, responsive interfaces that blend aesthetics with
            flawless usability from wireframe to pixel-perfect reality.
          </div>
          <div className="feature-grid">
            <div className="feature-item">
              ...
              <span className="feature-text">UI / UX</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">React.Js/ Tailwind</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Typography</span>
            </div>
            <div className="feature-item">
              <div className="feature-icon">
                <svg viewBox="0 0 24 24">
              ...
              <span className="feature-text">Animation</span>
            </div>
          </div>
          <div className="card-actions">
            <div className="price">
              <span className="price-currency"></span>Projects
              <span className="price-period">interactive & live</span>
            </div>
            <button className="card-button">View Work</button>
          </div>
        </div>
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    position: relative;
    width: 100%;        /* fills the GSAP box */
    height: 100%;       /* fills the GSAP box */
    background: var(--bg);
    ...
    font-size: clamp(10px, 2vw, 14px); /* fluid type so it fits the card */
  }

  .card:hover {
    transform: translate(-0.3em, -0.3em) scale(1.01);
    box-shadow: 0.8em 0.8em 0 var(--shadow-color);
  }
  ...
  .card-title-area::before {
    ...
    background: repeating-linear-gradient(
      45deg,
      rgba(0,0,0,0.1), rgba(0,0,0,0.1) 0.5em,
  ...
  .feature-icon svg { width: 0.8em; height: 0.8em; fill: var(--bg); }
  ...
  .card-actions {
    ...
    align-items: center;
    padding-top: 0.8em;
    border-top: 0.12em dashed rgba(0,0,0,0.15);
    position: relative;
    margin-top: auto;
  }
  ...
  .price-currency { font-size: 0.55em; font-weight: 700; vertical-align: top; margin-right: 0.1em; }
  ...
  .card-button:active { transform: translate(0.1em, 0.1em); box-shadow: 0.12em 0.12em 0 var(--shadow-color); }
  ...
  .stamp-text { font-size: 0.5em; font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em; }
