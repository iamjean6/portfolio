...
const educationData = [
  { id: 1, type: 'Degree', title: 'B.Sc. Statistics and Comp Science', date: '2023 - Present', desc: 'Bachelors degree for the foundational knowledge of my data and computer science path. Currently enrolled at the Technical University of Mombasa.', img: '/img/comp.jpg',link:''},
  ...
  { id: 6, type: 'Bootcamp', title: 'Build with AI with Unstacked labs', date: '2025', desc: 'AI development fundamentals using Google ADK, Genkit and Vertex AI for building production ready AI applications', img: '/img/bwai.jpg',link:"https://drive.google.com/file/d/1EqJu1WlVeVS11MFoX54VfJ2DjmvGhWGL/view?usp=drive_link" },
];
